...
namespace SST {
    namespace Kingsley {
        ...
        public:
            enum NocEventType {
                CREDIT, PACKET, INTERNAL, INITIALIZATION
            };
        ...
        public:
            ...
            virtual void print(const std::string &header, Output &out) const override {
                out.output("%s RtrEvent to be delivered at %"
                PRIu64
        ...
        public:
            ...
            virtual void print(const std::string &header, Output &out) const override {
                out.output("%s credit_event to be delivered at %"
                PRIu64
                " with priority %d\n",
        ...
        public:
            ...
            enum Commands {
                ...
                COMPUTE_X_SIZE,
                COMPUTE_Y_SIZE,
                COMPUTE_ENDPOINT_START,
                BROADCAST_TOTAL_ENDPOINTS,
                BROADCAST_X_SIZE,
                BROADCAST_Y_SIZE,
                COMPUTE_X_POS,
                COMPUTE_Y_POS,
            ...
            virtual void print(const std::string &header, Output &out) const override {
                out.output("%s NocInitEvent to be delivered at %"
                PRIu64
                " with priority %d\n",
                    header.c_str(), getDeliveryTime(), getPriority());
